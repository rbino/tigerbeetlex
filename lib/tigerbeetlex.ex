defmodule TigerBeetlex do
  ...
  from the `TigerBeetlex.Processless` client and translate them in a blocking API.

  If you already have a wrapping process, you can use `TigerBeetlex.Processless` directly instead.
  """
  ...
  ## Examples
      ...
      # Start the TigerBeetlex client
      {:ok, pid} = TigerBeetlex.start_link(cluster_id: 0, addresses: ["3000"], concurrency_max: 32)

      # Start a named TigerBeetlex client
      {:ok, pid} =
        TigerBeetlex.start_link(cluster_id: 0, addresses: ["3000"], concurrency_max: 32, name: :tb)
  """
  ...
  ## Examples
      ...
      {:ok, stream} = TigerBeetlex.create_accounts(:tb, batch)
  ...
  ## Examples
      ...
      {:ok, stream} = TigerBeetlex.create_transfers(:tb, batch)
  ...
  ## Examples
      ...
      {:ok, stream} = TigerBeetlex.lookup_accounts(:tb, batch)
  ...
  ## Examples
      ...
      {:ok, stream} = TigerBeetlex.lookup_transfers(:tb, batch)
