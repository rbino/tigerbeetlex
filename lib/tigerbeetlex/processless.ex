defmodule TigerBeetlex.Processless do
  ...
  ## Examples
      ...
      {:ok, client} = TigerBeetlex.Processless.connect(0, ["3000"], 32)
  """
  @spec connect(
  ...
  `client` is a `%TigerBeetlex.Processless{}` client.
  ...
  ## Examples
      ...
      {:ok, ref} = TigerBeetlex.Processless.create_accounts(client, batch)
  ...
  ## Examples
      ...
      {:ok, ref} = TigerBeetlex.Processless.create_transfers(client, batch)
  ...
  ## Examples
      ...
      {:ok, ref} = TigerBeetlex.Processless.lookup_accounts(client, batch)
  ...
  ## Examples
      ...
      {:ok, ref} = TigerBeetlex.Processless.lookup_transfers(client, batch)
